...
def update_item(session, item_id, name=None, description=None, category_ids=None, image_url=None):
  ...
  if category_ids is not None:
    ...
    for cat_id in category_ids:
      item_to_cat = ItemToItemCategory(item_id=item_id, item_category_id=cat_id)
